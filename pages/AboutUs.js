  ...
  return (
    <div className="about-us-container">
      ...
      <header className="about-us-header">
        ...
        <p className="about-us-subtitle">Express Yourself with Flow State</p>
      </header>

      {/* Section 1: The Birth of Your Brand */}
      <section className="about-us-section">
        <h2 className="section-title">The Birth of Flow State</h2>
        <p className="section-text">
          We started Flow State with one simple idea: to give people the power to express themselves through their clothing. In a world that often follows the trends, we wanted to stand out, offering something unique, bold, and unapologetically personal.
        </p>
        <img 
          src="/img/story1.jpg" 
      ...
      <section className="about-us-closing">
        ...
        <p className="closing-text">
          We’re excited to have you with us on this journey of creativity and self-expression. Welcome to Flow State. Welcome to a world of your own making.
        </p>
      </section>
    </div>
  );
